...
- [x] **Phase 4: Open questions register** — Catalogue every "couldn't verify" + design-decision-deferred item, assign owner / phase; output `.planning/OPEN-QUESTIONS.md` *(execution complete 2026-05-10; gsd-verifier PASS 45/45; awaiting milestone-final approval)*
